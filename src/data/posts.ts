...
export const POSTS: Post[] = [
  ...
  { id: 5, schoolId: 2, title: "Экологиялық акция: «Таза мектеп»", content: "Оқушыларымыз «Таза мектеп» экологиялық акциясын өткізді. Мектеп ауласында 50-ден астам ағаш отырғызылды.", date: "2026-03-20", valueTag: "Тәрбие", valueIcon: "🌱", likes: 189, comments: 28, shares: 22, saved: 19 },
  ...
  { id: 9, schoolId: 9, title: "Мектеп достығы фестивалі", content: "«Мектеп достығы» фестивалі аясында мектеп ішіндегі ынтымақтастықты нығайтатын ойындар мен байқаулар ұйымдастырылды.", date: "2026-03-10", valueTag: "Достық", valueIcon: "💛", likes: 201, comments: 38, shares: 30, saved: 25 },
